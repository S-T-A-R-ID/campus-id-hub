...
export default function StudentAuthForm() {
  ...
  useEffect(() => {
    if (searchParams.get("verification") === "required") {
      toast.error("Please verify your email before accessing the portal.");
    }
  }, [searchParams]);
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upsert profile with name and reg number for prefill
      if (data.user) {
      ...
      <Card className="border-0 shadow-xl">
        ...
        <CardContent className="space-y-3 p-4 pt-0 sm:p-6 sm:pt-0">
          ...
          <p className="text-xs text-muted-foreground text-center">
            Tip: open the newest verification email if you requested multiple links.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <Card className="border-0 shadow-xl">
        ...
        <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
          ...
          <div className="mt-4 text-center text-sm sm:mt-6">
            ...
            <button onClick={() => { setIsLogin(false); setShowVerificationNotice(false); }} className="text-primary font-medium hover:underline">Sign up</button>
          </div>
        </CardContent>
      </Card>
    );
    ...
    <Card className="border-0 shadow-xl">
      ...
      <CardContent>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <button onClick={() => { setIsLogin(true); setShowVerificationNotice(false); }} className="text-primary font-medium hover:underline">Sign in</button>
        </div>
      </CardContent>
    </Card>
  );
